# 08. (선택) WiFi + HTTP — 웹서버의 LED 를 따라 켜기

> 🔗 **선택 심화 과정**입니다. [06-web-server-python](../../06-web-server-python/README.md) 강좌에서 만드는
> **LED 서버**가 필요하므로, 그 강좌를 마친 뒤(또는 서버를 띄워 줄 사람이 있을 때) 돌아오세요.
...
서버는 따로 만들지 않습니다. **06-web-server-python 의 LED 서버**를 그대로 씁니다.
