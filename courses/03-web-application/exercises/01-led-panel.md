...
> **서버 없이** 브라우저만으로 동작 — 05·06 강좌에서 이 화면을 서버·ESP32 에 연결합니다.
>
...
> ESP32 LED를 켜게) 만드는 것이 다음 강좌 05-web-server-python 의 목표예요.
...
➡️ 다음 강좌: [05-web-server-python](../../05-web-server-python/README.md)  (그 전에 [04-python-programming](../../04-python-programming/README.md) 으로 파이썬 기초를 다집니다)
