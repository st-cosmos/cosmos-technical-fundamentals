...
> 이 기초 위에 [05-web-server-python](../05-web-server-python/README.md) 의 FastAPI 서버가 올라갑니다.

## 누구를 위한 자료인가

- **대상**: 프로그래밍 언어를 하나 정도 살짝 본 부원 (C/C++ 조금, 또는 03 강좌의 JS 정도)
...
```bash
cd courses/04-python-programming/examples/02-led-logger
uv run main.py
```
...
- [05-web-server-python](../05-web-server-python/README.md) — 여기서 배운 딕셔너리·함수·uv 가 그대로 FastAPI 서버가 됩니다
