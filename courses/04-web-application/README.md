# 04. 웹 애플리케이션 — HTML · CSS · JavaScript
...
> 있습니다. 이 화면은 [06-web-server-python](../06-web-server-python/README.md) 에서 서버·ESP32 와 연결됩니다.
...
- [05-python-programming](../05-python-programming/README.md) — 서버를 만들기 위한 파이썬 기초
- [06-web-server-python](../06-web-server-python/README.md) — 이 LED 제어판을 FastAPI 서버에 올리고, API·WebSocket 으로 연결
