...
## 7. JavaScript — 서버 통신 미리보기 (06 강좌에서 자세히)
...
| **Network** | 요청/응답 목록 (06 강좌에서 핵심) |
| 요소 선택(↖ 아이콘) | 화면 클릭 → 해당 HTML 로 이동 |

## 다음 단계

➡️ 실습 [`exercises/01-led-panel.md`](../exercises/01-led-panel.md) → 다음 강좌 [05-python-programming](../../05-python-programming/README.md)
