...
정적 파일 호스팅 → REST API → fetch/polling → WebSocket — 웹서버의 한 바퀴를 모두 돌았습니다. 03 강좌의 화면, 04 강좌의
딕셔너리·함수, 그리고 여기의 서버가 한 앱으로 이어졌고, ESP32([06 강좌 docs/08](../../06-esp32-programming/docs/08-wifi-http-client.md))
