...
> 이 서버는 다음 06 강좌에서 **ESP32**(WiFi 실습)가 그대로 재사용합니다.
>
...
이 LED 서버는 그냥 연습이 아닙니다. 다음 06 강좌에서 **ESP32**(WiFi 실습)가 이 서버에
...
- 같은 서버에 **ESP32**([06 강좌 docs/08](../../06-esp32-programming/docs/08-wifi-http-client.md))를 붙여 실제 LED 켜기
