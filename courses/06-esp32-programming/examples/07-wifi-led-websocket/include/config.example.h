...
// WebSocket 서버(05 강좌 examples/03-led-websocket)를 띄운 PC 의 주소.
//   - 06 예제의 SERVER_URL 과 달리 "http://" 없이 IP 와 포트를 따로 적는다.
//   - PC 의 실제 IP (localhost/127.0.0.1 은 ESP32 에서 접근 불가)
//   - Windows: ipconfig 의 IPv4 주소 / macOS·Linux: ifconfig 또는 ip addr
#define SERVER_HOST   "PC의_IP주소"     // 예) "192.168.0.10"
#define SERVER_PORT   8000
#define SERVER_PATH   "/ws"            // 서버의 WebSocket 엔드포인트
