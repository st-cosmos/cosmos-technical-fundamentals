...
- **대상**: 웹 페이지(04)와 파이썬 기초(05)를 마친 부원
- **선수**: [04-web-application](../04-web-application/README.md), [05-python-programming](../05-python-programming/README.md) (uv · 딕셔너리 · 함수)
- **도구**: uv, VS Code, 크롬(F12 Network 탭)

## 폴더 구조

```
06-web-server-python/
├── docs/
...
├── examples/
│   ├── 01-static-hosting/             최소 서버 + static/ (04 의 LED 제어판)
...
05 강좌의 LED 이력 기록기, 03 강좌의 ESP32 펌웨어가 같은 모양을 씁니다.
