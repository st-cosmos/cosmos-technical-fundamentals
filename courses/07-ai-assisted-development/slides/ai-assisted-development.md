...
<div class="lead-sub">06 의 LED 서버에 "변경 이력" 추가</div>
...
- **실습 2** ★: 06 의 **LED 서버**에 이력 API + 화면 추가 — git 안전망 · AGENTS.md · 계획 · 단계 · 테스트 · 버그 수정 · 리뷰 (`exercises/02`)

> 같은 "LED 제어판"을 04 에서는 **손으로**, 07 에서는 **말로**. 결과가 맞는지 **판단**할 수 있는 건 04~06 의 기본기 덕분.
